...
A few notes on each dataset: - The simplex features generate only two
clusters for all metrics except *cosine*, which gives 8 clusters. The
silhouette width is very small, though, for this 8-cluster one. - The
same is true of the custom variable set, which equally has a very small
