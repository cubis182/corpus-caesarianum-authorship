...
object %<>% map(~ .x)
names(object) <- c("simplex", "gorman", "caesar_gorman", "custom", "custom_caesar")#, "sectioned")
summary(object)
```
...
# The input to this block is a set of `dist` objects from the previous code block's agglomerative clustering, the variables titled algorithms_dist and algorithms_agglom
