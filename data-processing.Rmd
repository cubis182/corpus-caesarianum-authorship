...
## Dissimilarity Verification with Sections
...
Now we'll create a list of vectors, and each one is the set of
correlations retrieved by comparing pairwise
...
Using Spearman with the AS89 approximation, BA took 208.86 seconds to
execute. We'll stick with that for now.

Let's create a function that does this all for us and gets us a list of
vectors.
