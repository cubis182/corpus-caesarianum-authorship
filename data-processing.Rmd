...
# I will do this with only Euclidean distance for pvclust to save on computation time, especially given what we saw in the code blocks above and the challenges with cosine similarity.

pvclust_results <- c(
  # A map function for each distance metric with different linkage methods
  imap(
    object[3:4],
    \(x, y) structure(pvclust(x, "ward.D2", "euclidean"), dataset = y, method = "ward.D2", metric = "euclidean")
  )
)
