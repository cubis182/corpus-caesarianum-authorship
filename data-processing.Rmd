...
select_top_variables <- function(all_vars, n) {
  ...
  all_vars_reduced <- all_vars %>=% filter(n > 20)
...
# profvis({
all_vars_by_book <- get_vars("book", data, presupplied_variables=NULL)
# })
...
profvis({ .GlobalEnv$all_vars_by_book <- all_vars_by_book |>
  select_top_variables(n = 1000) |>
  transpose_all_vars()
})


# all_vars_by_book %<>% transpose_all_vars() %<>%
#   select_top_variables(n = 1000)
# 
...
verify_random_cell(all_vars, source_data) {
