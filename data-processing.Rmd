...
if (params$use_parent) data %<>% dplyr::select(-parent_Voice)
...
ablative, oblique argument with a 3rd person verb parent". The custom_vars_* 
variables are a new set combining syntactic and lexical information; 
this variable set includes the most frequent lemmas, POS, and POS n-grams, as
described in the Custom Variables section above.

```{r}

# Clear everything from previous sections of the notebook, and replace necessary variables
rm(list = ls()); gc()
source("functions.R")
params <- list(
  use_parent = FALSE,
